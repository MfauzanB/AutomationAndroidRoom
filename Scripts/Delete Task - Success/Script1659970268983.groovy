...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Task Title'), 'kue', 0)

Mobile.tap(findTestObject('Object Repository/android.widget.EditText - Task Content'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Task Content (1)'), 'padi', 0)
